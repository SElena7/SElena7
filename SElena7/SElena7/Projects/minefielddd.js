class Minefield {
    ...
    /*change here by me*/
    /* Return representation of the field as string ARRAY. */
    ...
    toString() {
        ...
        var outputlen=output.length;//sakam da ja dobijam dolzinata 
        var outputArray=[];
        console.log(outputlen);//110
        for(var i=0;i<=outputlen;i++){
        
        outputArray.push(output.charAt(i));
